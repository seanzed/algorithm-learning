...
public class LCS {
    ...
    public static void main(String[] args) {
        ...
        int len1 = lcs1(new int[] {1, 3, 5, 9, 10}, new int[] {1, 4, 9, 10});
        System.out.println(len1);

        int len2 = lcs2(new int[] {1, 3, 5, 9, 10}, new int[] {1, 4, 9, 10});
        System.out.println(len2);

        int len3 = lcs3(new int[] {1, 3, 5, 9, 10}, new int[] {1, 4, 9, 10});
        System.out.println(len3);

        int len4 = lcs4(new int[] {1, 3, 5, 9, 10}, new int[] {1, 4, 9, 10});
